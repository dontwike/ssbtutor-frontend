    ...
    return (
        <div className="flex flex-col w-full md:w-1/2 xl:w-2/5 2xl:w-2/5 3xl:w-1/3 mx-auto p-8 md:p-10 2xl:p-12 3xl:p-14 rounded-2xl">
            <form className="flex flex-col">
                ...
                <div className="pb-6">
                    <label htmlFor="password" className="block mb-2 text-base font-medium text-[#e6e9ed]">Password</label>
                    <div className="relative text-gray-400">
                        <span className="absolute inset-y-0 left-0 flex items-center p-1 pl-3">
                ...
                <div className="text-sm font-light text-[#79849b] text-center">
                    Don't have an account yet? <a href="/register" className="font-medium text-[#4F46E5] hover:underline">Sign Up</a>
                </div>
            </form>
        </div>
    );
