        ...
        return comments
            ...
            .map((comment) => (
                ...
                >
                    ...
                    {visibleComments[comment._id] && renderComments(comments, comment._id)}
                </article>
            ));
    };

    return (
        <section className="bg-[#1D232A] py-8 lg:py-16 antialiased">
            <div className="max-w-2xl mx-auto px-4">
                ...
                <form className="mb-6" onSubmit={handleNewComment}>
                    <textarea
                        ...
                        value={newComment}
                        onChange={(e) => setNewComment(e.target.value)}
                        className="w-full px-2 py-1 text-sm text-gray-900 border border-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500 dark:text-white bg-[#1D232A]"
